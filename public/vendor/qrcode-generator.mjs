//---------------------------------------------------------------------
// Vendored, unmodified: qrcode-generator@2.0.4 (npm), dist/qrcode.mjs.
// MIT licensed (c) Kazuhiko Arase, see below. To update:
// npm pack qrcode-generator@<version>, extract, copy dist/qrcode.mjs
// over this file.
// Exports: default (qrcode factory) and stringToBytes.
// Usage: qrcode(0, 'H').addData(text); .make(); .createSvgTag({...})
//---------------------------------------------------------------------
//
